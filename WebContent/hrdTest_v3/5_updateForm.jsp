    ...
    <%@ include file="top.jsp" %>
        <section>
            ...
            -->
               ...
               <!-- hidden 추가 대신 다른 방법 : 회원번호 input의 readonly 속성을 설정 
               		입력불가를 표현하기 위한 css가 필요합니다.
                -->
                <table style="width: 70%;margin:auto">
                    <tr>
                        <td class="col1_title">회원번호(자동발생)</td>
                        <td><input type="text" name="num" value="${member.custNo }" disabled="disabled"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="grade" value="${member.grade }" 
